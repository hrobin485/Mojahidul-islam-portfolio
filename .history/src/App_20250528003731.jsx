...
import { 
  FaReact, FaNodeJs, FaHtml5, FaCss3Alt, FaGitAlt, FaGithub, FaStripe, FaFirebase 
} from 'react-icons/fa';
import { SiJavascript, SiMongodb, SiExpress, SiTailwindcss, SiPostman, SiJsonwebtokens } from 'react-icons/si';
import { MdGroups, MdAccessTime, MdAutoFixHigh, MdOutlineDiversity3, MdPsychology, MdOutlineLeaderboard } from 'react-icons/md';
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
              {[
                ...
                "MongoDB", "Tailwind CSS", "HTML5", "CSS3",
                "Firebase", "Git", "GitHub", "JWT",
                "REST API", "Stripe", "Postman"
              ].map(skill => (
                <div key={skill} className="bg-white shadow rounded-lg p-4 hover:bg-blue-100 transition text-center font-medium">
                  {skill}
                </div>
              ))}
            </div>
