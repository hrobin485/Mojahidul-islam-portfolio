      ...
      <section id="projects" className="py-20 bg-gradient-to-r from-blue-500 to-indigo-600 text-white" data-aos="fade-up">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Project: StudyHive */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105 hover:shadow-2xl group flex flex-col md:flex-row">
              ...
              <div className="p-6 flex-1">
                <img
                  src="https://via.placeholder.com/400x300" // Replace with actual preview image URL
                  alt="Project Preview"
