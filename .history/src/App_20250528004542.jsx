      ...
      <section id="projects" className="py-20 bg-gray-100" data-aos="fade-up">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Project: StudyHive */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transition hover:shadow-xl text-left">
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-blue-600">StudyHive – Online Group Study Platform</h3>
                ...
                <div className="flex gap-4 text-sm font-medium">
                  <a href="#" className="text-blue-500 hover:underline">Client Code</a>
                  <a href="#" className="text-blue-500 hover:underline">Server Code</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transition hover:shadow-xl text-left">
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 text-blue-600">CrowdFunding – Donation-Based Campaign Platform</h3>
                <p className="text-gray-700 mb-3">
                  A responsive web application where users can create, manage, and donate to fundraising campaigns.
                </p>
                <p className="text-sm text-gray-500 mb-2"><strong>Tech Stack:</strong> React.js, Node.js, Express.js, MongoDB, Firebase, Tailwind CSS, JWT</p>
                <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
                  <li>Add, update, and delete campaigns with Firebase Auth</li>
                  <li>Protected routes using JWT</li>
                  <li>Donate to campaigns (restricted after deadline)</li>
                  <li>Campaign filtering and sorting</li>
                  <li>User dashboard for campaign management</li>
                </ul>
                <div className="flex gap-4 text-sm font-medium">
                  <a href="#" className="text-blue-500 hover:underline">Client Code</a>
                  <a href="#" className="text-blue-500 hover:underline">Server Code</a>
