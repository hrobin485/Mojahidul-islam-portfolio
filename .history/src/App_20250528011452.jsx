...
function App() {
  ...
  return (
    <div className="font-sans scroll-smooth">
      ...
      <section id="projects" className="py-20 bg-gradient-to-r from-blue-500 to-indigo-600 text-white" data-aos="fade-up">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-extrabold mb-12 text-white">My Projects</h2>

          <div className="space-y-8">
            {/* Project: StudyHive */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105 hover:shadow-2xl group flex flex-col md:flex-row w-full">
              {/* Left Side: Project Info */}
              <div className="p-6 flex-1">
                <h3 className="text-2xl font-semibold mb-3 text-blue-600 group-hover:text-blue-800 transition-all">
                  <a
                ...
                <p className="text-gray-700 mb-3 opacity-90 group-hover:opacity-100 transition-all duration-300">
                  A platform for students to create or join study groups, submit assignments, and get feedback from peers and instructors.
                </p>
                <p className="text-sm text-gray-500 mb-2"><strong>Tech Stack:</strong> React.js, Node.js, Express.js, MongoDB, Firebase, Tailwind CSS, JWT</p>
                <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
                  <li>Email/Google login with JWT authentication</li>
                  <li>Create, submit, and grade assignments (role-based)</li>
                  <li>Filter and search assignments by difficulty</li>
                ...
                <div className="flex flex-col gap-2 text-sm font-medium">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-500 hover:underline group-hover:text-blue-700 transition"
                  >
                    🔗 Live Site
                  </a>
                  <a
              ...
              <div className="p-6 flex-1">
                <img
                  src="https://via.placeholder.com/1200x500" // Replace with actual preview image URL
                  alt="Project Preview"
                  className="rounded-lg shadow-md w-full h-full object-cover transition-transform transform group-hover:scale-105"
                />
              </div>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transition transform hover:scale-105 hover:shadow-2xl group flex flex-col md:flex-row w-full">
              ...
              <div className="p-6 flex-1">
                ...
                <p className="text-gray-700 mb-3 opacity-90 group-hover:opacity-100 transition-all duration-300">
                  A responsive web application where users can create fundraising campaigns and donate to others. Includes authentication, protected routes, and user-specific dashboards.
                </p>
                <p className="text-sm text-gray-500 mb-2"><strong>Tech Stack:</strong> React.js, Node.js, Express.js, MongoDB, Firebase, Tailwind CSS, JWT</p>
                <ul className="list-disc list-inside text-sm text-gray-600 mb-4">
                  <li>Add, update, and delete campaign functionality with Firebase Auth</li>
                  <li>Private routes with JWT protection</li>
                  <li>Donate to active campaigns, restricted after deadline</li>
                  <li>Campaign sorting, dark/light theme toggle</li>
                  <li>User dashboard to manage created and donated campaigns</li>
                </ul>
                <div className="flex flex-col gap-2 text-sm font-medium">
                  <a
                    href="https://winter-clothing-donation-9b03b.web.app/"
