            ...
            <div className="bg-gray-100 rounded-lg p-6 shadow hover:bg-blue-50 transition">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Rajshahi College,Rajshahi — <span className="italic">2017-2022</span></p>
                </div>
              </div>
            ...
            <div className="bg-gray-100 rounded-lg p-6 shadow hover:bg-blue-50 transition">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Programming Hero — <span className="italic">June,2024-January,2025</span></p>
                </div>
              </div>
              <p className="text-gray-700">
