            ...
            <div className="bg-white shadow-lg rounded-2xl overflow-hidden transition transform hover:scale-105 hover:shadow-2xl group flex flex-col md:flex-row w-full">
              ...
              <div className="flex-1">
                <img
                  ...
                  className="w-full h-full p-5 rounded-l-none rounded-r-2xl md:rounded-l-2xl md:rounded-r-none shadow-md transition-transform transform group-hover:scale-105"
                />
              </div>
            </div>
