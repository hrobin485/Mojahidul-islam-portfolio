    ...
    <div className="font-sans scroll-smooth">
      ...
      >
        ...
        <div className="w-full md:w-1/2 mt-10 md:mt-0 flex justify-center">
          <img
            src="/public/image/mojahidul.jpg" // Replace with your actual image path
            alt="Your Portrait"
          ...
          <div className="space-y-12">
            ...
            <div className="bg-white shadow-lg rounded-2xl overflow-hidden transition transform hover:scale-105 hover:shadow-2xl group flex flex-col md:flex-row w-full">
              ...
              <div className="flex-1 p-7">
                <img
                  src="/public/image/StudyHivePNG.PNG"
            ...
            <div className="bg-white shadow-lg rounded-2xl overflow-hidden transition transform hover:scale-105 hover:shadow-2xl group flex flex-col md:flex-row w-full">
              ...
              <div className="flex-1 p-7">
                <img
                  src="/public/image/CrowdFunding.PNG"
            ...
            <div className="bg-gray-100 rounded-lg p-6 shadow hover:bg-blue-50 transition">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">XYZ University, Dhaka — <span className="italic">2019 - 2023</span></p>
                </div>
              </div>
              <p className="text-gray-700">
                Learned core subjects like Data Structures, Algorithms, Web Development, and Software Engineering.
              </p>
            </div>

            {/* Course Block with Certificate */}
            <div className="bg-gray-100 rounded-lg p-6 shadow hover:bg-blue-50 transition">
              <div className="flex items-center gap-4 mb-4">
                <FaLaptopCode className="text-green-600 text-4xl" />
                <div>
                  <h3 className="text-xl font-semibold">MERN Stack Development</h3>
                  <p className="text-sm text-gray-600">Programming Hero — <span className="italic">2024</span></p>
                </div>
              </div>
              <p className="text-gray-700 mb-4">
                Gained practical experience with MongoDB, Express, React, and Node.js. Built real-world full-stack projects.
              </p>
              <a
                href="https://your-certificate-link.com" // replace with your actual certificate link
                target="_blank"
                rel="noopener noreferrer"
