    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div className="bg-gray-100 rounded-lg p-6 shadow hover:bg-blue-50 transition">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Complete MERN Stack Development</h3>
            <p className="text-sm text-gray-600">Programming Hero — <span className="italic">2024</span></p>
          </div>
        </div>
        <p className="text-gray-700">
          Practical hands-on experience with MongoDB, Express, React, and Node.js, along with deployment, REST APIs, authentication, and project building.
        </p>
      </div>
